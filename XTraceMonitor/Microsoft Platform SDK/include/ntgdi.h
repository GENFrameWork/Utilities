...
NtGdiDvpCanCreateVideoPort(
    __in HANDLE hDirectDraw,
    __inout PDD_CANCREATEVGPIO puCanCreateVGPIO
    );
...
NtGdiDvpCreateVideoPort(
    __in HANDLE hDirectDraw,
    __inout PDD_CREATEVGPIO puCreateVGPIO
    );

W32KAPI DWORD APIENTRY 
NtGdiDvpDestroyVideoPort(
    __in HANDLE hVideoPort,
    __inout PDD_DESTROYVGPIO puDestroyVGPIO
    );
...
NtGdiDvpFlipVideoPort(
    ...
    __inout PDD_FLIPVGPIO puFlipVGPIO
    );
...
NtGdiDvpUpdateVideoPort(
    ...
    __inout PDD_UPDATEVGPIO puUpdateVGPIO
    );
