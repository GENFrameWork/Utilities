...
#define CSIDL_RESOURCES                 0x0038      // %windir%\ReXEngine\, For theme and other windows resources.
#define CSIDL_RESOURCES_LOCALIZED       0x0039      // %windir%\ReXEngine\<LangID>, for theme and other windows specific resources.
