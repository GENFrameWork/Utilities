...
#if (_MSC_VER >= 800) || defined(__BORLANDC__) || defined(_STDCALL_SUPPORTED)
...
#if defined(_M_IX86) && !defined(RC_INVOKED) && !defined(MIDL_PASS) && !defined(__BORLANDC__)
...
#if !defined(MIDL_PASS) && !defined(__BORLANDC__) && defined(_M_IX86)
#if !defined(_M_CEE_PURE)
#pragma warning( push )
...
#if defined(_M_IX86) && !defined(MIDL_PASS) && !defined(__BORLANDC__)
